# Krissia gosta de bolinhas de queijo. Ela quer saber quantas bolinhas de queijo dá para colocar dentro de um
...
# Sabendo que o volume de uma esfera de raio r é V = 4 3πr3, o volume do pote de sorvete é V = x· y · z e o fator
...
volume_espera = (4/3) * pi * raio ** 3
qtd_bolinhas = (volume_pote / volume_espera) * 0.74

print ("Quantidade de bolinhas de queijo suportadas pelo pote: {:.0f}".format(qtd_bolinhas))