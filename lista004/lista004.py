...
pessoas = {"jeferson": "branca", "maria": "azul", "joao": "verde", 
                    "jose": "vermelho", "geovane": "cinza"}
...
semana = {"segunda": ["engenharia de software", "tópicos avançados"], "terca": ["eng. de software"],
        "quarta": [], "quinta": ["programacao python"], "sexta": ["metodos cientificos em computacao"],
        "sabado": [], "domingo": []}
...
filmes = {"interestelar": {"ano de lancamento": 2014, "vilao": "terra"}, 
        "ironman 1": {"ano de lancamento": 2008, "vilao": "modok"},
        "avengers endgame": {"ano de lancamento": 2019, "vilao": "thanos"},
        "aquaman": {"ano de lancamento": 2018, "vilao": "Orm"},
        "american beauty": {"ano de lancamento": 1999, "vilao": "nenhum"}}
...
d = {"nome": "Matheus Alves", "idade": 23, "telefone": "(71) 9 0000-0000", 
