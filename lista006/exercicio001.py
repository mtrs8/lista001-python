...
peso_diario = float(input("Peso dos peixes (em kg): "))

if peso_diario > 50:
    print("O peso está acima do permitido. A multa é de R$", (peso_diario - 50) * 4)
else:
    print("O peso está dentro do permitido.")